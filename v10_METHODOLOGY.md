...
**Canonical dataset:** `v10.csv` — 456 findings · 211 reports · 40 columns
**Corpus window:** each organisation's first publication → **2026-07-30** (frozen cutoff)
...
| Artifact | Role |
|---|---|
| `v10.csv` | The dataset. 456 findings × 40 columns |
