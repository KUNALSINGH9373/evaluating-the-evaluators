...
RED, AMBER, GREY = "#C62F1F", "#E8A80C", "#666666"
...
P = os.path.expanduser("~/MATS/Research/AISI_Evals/dataset/AISIEVAL.xlsx")
...
ax.plot(years, noact, "--s", color=GREY, linewidth=2.6, markersize=10, zorder=2,
...
for x, y in zip(years, noact):
    ax.annotate(f"{y:.0f}%", (x, y), textcoords="offset points", xytext=(0, -30),
                ha="center", fontsize=19, color=GREY)
ax.set_ylim(0, 112)
...
fig.text(0.02, 0.015,
         f"Tier A ∩ severity C1, n={len(H)}. 2023 and 2024 are small samples; 2026 is partial (cutoff 31 July 2026). "
         ...
         fontsize=13.5, color="#333333", linespacing=1.6)
